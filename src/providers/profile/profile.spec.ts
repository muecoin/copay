...
describe('Profile Provider', () => {
  ...
  const walletFixture = {
    api1: {
      ...
      status: {
        availableBalanceSat: 1000000000 // 10 MUE
      },
      isComplete: () => {
        return true;
      },
    ...
    api3: {
      ...
      status: {
        availableBalanceSat: 150000000 // 1.50 MUE
      },
      isComplete: () => {
        return true;
      },
  ...
  class PersistenceProviderMock {
    ...
    getBalanceCache(walletId: any) {
      return Promise.resolve('0.00 MUE');
    }
